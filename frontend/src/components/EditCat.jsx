// filepath: c:\Users\Miguel Perico\websys_project\frontend\src\components\EditCat.jsx
...
const EditCat = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await axios.put(`/api/cats/${id}`, cat);
    navigate('/admin');
  };
  ...
  return (
    <div className="container mx-auto p-4 bg-slate-100">
      ...
      <h1 className="text-2xl font-bold mb-4 text-slate-950">Edit Cat</h1>
